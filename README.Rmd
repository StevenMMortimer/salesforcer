...
<!-- badges: start -->
[![R Build Status](https://github.com/StevenMMortimer/salesforcer/workflows/R-CMD-check/badge.svg)](https://github.com/StevenMMortimer/salesforce/actions?workflow=R-CMD-check)
...
The README below outlines the basic package functionality. Review the vignettes 
for more detailed examples on usage.
...
it so you will not have to call `sf_auth()` during each session if you have a 
