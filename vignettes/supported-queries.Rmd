...
In the example below we are retrieving all Contact object records that have a 
...
differently. One aspect to note is that the Bulk 2.0 API does not support
child-to-parent-grandparent relationships like so:
