...
with. You'll notice that the Account column does not appear in the results. This 
is because Salesforce does not return Account information if it does not exist and 
there is no way reliable way to extract and rebuild the emply columns based on the 
query string. If there were Account information, an additional column titled "Account.Name" 
