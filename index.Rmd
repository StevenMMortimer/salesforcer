...
**NOTE**: Beginning February 1, 2022 authentication via a username and password
will not work in most orgs. On that date Salesforce will begin requiring customers
to enable multi-factor authentication (MFA). The function `sf_auth()` will 
