...
<br>
<img src="man/figures/logo-big.png" width="120px" align="right" />

**salesforcer** is an R package that connects to Salesforce APIs using tidy principles. 
The package implements most actions from the SOAP, REST and Bulk APIs. 
...
instead of the SOAP or REST APIs.
